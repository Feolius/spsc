...
np.savetxt("gamma_potential_C236.csv", potential_1, delimiter=",")
ax.plot(x, potential_2, label='X')
np.savetxt("X_potential_C236.csv", potential_2, delimiter=",")
ax.plot(x, wf_1, label=r'$\psi_\Gamma$1')
np.savetxt("wf1_C236.csv", wf_1, delimiter=",")
ax.plot(x, wf_2, label=r'$\psi_\Gamma$2')
np.savetxt("wf2_C236.csv", wf_2, delimiter=",")
ax.plot(x, wf_x, label=r'$\psi_X$')
np.savetxt("wfx_C236.csv", wf_x, delimiter=",")
ax.plot(x, E1.value * np.ones((len(potential_1), ), "float64"), label=r'$E_\Gamma$')
np.savetxt("E1_C236.csv", E1.value * np.ones((len(potential_1), ), "float64"), delimiter=",")
ax.plot(x, E2.value * np.ones((len(potential_1), ), "float64"), label=r'$E_\Gamma$')
np.savetxt("E2_C236.csv", E2.value * np.ones((len(potential_1), ), "float64"), delimiter=",")
ax.plot(x, Ex.value * np.ones((len(potential_1), ), "float64"), label=r'$E_x$')
np.savetxt("Ex_C236.csv", Ex.value * np.ones((len(potential_1), ), "float64"), delimiter=",")
ax.plot(x, Ef.value * np.ones((len(potential_1), ), "float64"), label=r'$E_f$', ls='-.', c='black')
np.savetxt("Ef_C236.csv", Ef.value * np.ones((len(potential_1), ), "float64"), delimiter=",")
