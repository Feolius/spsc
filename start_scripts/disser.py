...
ax.plot(x, E1.value * np.ones((len(potential_1), ), "float64"), label=r'$\epsilon_\Gamma$')
ax.plot(x, Ex.value * np.ones((len(potential_1), ), "float64"), label=r'$\epsilon_X$')
ax.plot(x, Ef.value * np.ones((len(potential_1), ), "float64"), label=r'$\epsilon_F$', ls='-.', c='black')
